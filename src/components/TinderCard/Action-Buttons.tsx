  ...
  return (
    ...
    >
      <button
        ...
        onClick={() => swipe("left")}
      >
        <Image src="/svg/peace-dove-svgrepo-com(1).svg" alt="peace dove" />
      </button>
      ...
      <button
        ...
        onClick={() => swipe("up")}
      >
        <Image src="/svg/punch-blast-svgrepo-com.svg" alt="super smash" />
      </button>
      ...
      <button
        ...
        onClick={() => swipe("right")}
      >
        <Image src="/svg/punch-svgrepo-com.svg" alt="punch" className="h-12" />
      </button>
    </section>
  );
}
